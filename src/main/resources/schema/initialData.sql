...
Equipped with a large 0.66-inch OLED screen, the L8STAR BM10 offers you the ultimate visual experience. It uses the MTK6261D processor, which makes you listen to music smoothly. Besides, dual card dual standby design combined with low radiation, it is healthy and convenient for your life. Large 350mAh capacity battery offers you a very great experience.',
       ...
       ('Apple MacBook Air', 'Υψηλές επιδόσεις χάρις τον 6πύρηνο επεξεργαστή Intel® Core™ i5 5350U 1.80 Ghz με τεχνολογία Turbo Boost χρονίζεται στα 2.90 Ghz  το σύστημα σου αλλάζει εποχή στην ταχύτητα. Τρέχει τα κυριολεκτικά τα πάντα, απροβλημάτιστα!',
        771.2, 52, 'Apple', 'laptop'),
       ('Lenovo IdeaPad 3', 'Το Lenovo IdeaPad 3 απευθύνεται σε φοιτητές και οικιακούς χρήστες που αναζητούν έναν αξιόπιστο φορητό υπολογιστή για καθημερινή χρήση. Με τον επεξεργαστή i3-1215U και την οθόνη FHD, μπορεί να χειριστεί καθημερινές εργασίες όπως τον περιηγητή ιστού, το Office, τα email, τα κοινωνικά δίκτυα και πολλά άλλα.',
        428.05, 87, 'Lenovo', 'laptop'),
       ('Lenovo IdeaPad Flex 5', 'Το Lenovo IdeaPad Flex 5 14IAU7 είναι ένα laptop με οθόνη 14 ιντσών IPS touchscreen και ανάλυση Full HD, που σημαίνει ότι προσφέρει εξαιρετική ποιότητα εικόνας. Είναι εξοπλισμένο με έναν ισχυρό επεξεργαστή i7-1255U και 16GB RAM, τα οποία επιτρέπουν την άνετη εκτέλεση πολλών εργασιών ταυτόχρονα. Έχει επίσης μια μεγάλη μονάδα αποθήκευσης 512GB SSD, η οποία προσφέρει γρήγορους χρόνους φόρτωσης και εκκίνησης του συστήματος, καθώς και αρκετό αποθηκευτικό χώρο για τα αρχεία σας.',
        998, 47, 'Lenovo', 'laptop'),
       ('HP Victus 15-fa0013nv', 'Το HP Victus 15-fa0013nv απευθύνεται σε απαιτητικούς χρήστες που αναζητούν ένα φορητό υπολογιστή για gaming και εργασίες πολυμέσων. Πρόκειται για ένα κομψό μηχάνημα βάρους 2.29 κιλών.',
        1245, 97, 'HP', 'laptop'),
       ('Dell G16 7630', 'Το Dell G16 7630 είναι ένα Laptop που προορίζεται για Gaming με οθόνη 16".
...
• Βάρος 2.73Kg',
       ...
       ('Apple Watch SE 2022', 'Το Apple Watch SE είναι σχεδιασμένο για αυτούς που θέλουν ένα πιο οικονομικό και προσιτό έξυπνο ρολόι από την σειρά της Apple Watch. Απευθύνεται σε αυτούς που επιθυμούν να παρακολουθούν την υγεία τους, να λαμβάνουν ειδοποιήσεις και ενημερώσεις, να ακούν μουσική και να εκτελούν βασικές λειτουργίες όπως απάντηση σε τηλεφωνήματα και αποστολή μηνυμάτων.',
        364, 21, 'Apple', 'watch'),
       ('Samsung Galaxy Watch 6', 'Το smartwatch που σας γνωρίζει καλύτερα επέστρεψε με μια εξατομικευμένη εμπειρία ευεξίας. Ξεκινήστε την ημέρα σας με έναν απολαυστικό ύπνο χάρη στην Παρακολούθηση ύπνου που είναι τώρα διαθέσιμη στο Galaxy Watch6.',
